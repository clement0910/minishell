...
/*   Updated: 2021/04/29 16:32:16 by csapt            ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int built_in_unset(const char *var_name, char ***env_tab, t_env **env)
{
	t_env *tmp;
	t_env *before_tmp;
	t_env *tmp_next;
	...
	while (tmp)
	{
		if (ft_strcmp((char*)var_name, ((t_env_var*)tmp->content)->key) == 0)
